...
public:
  ...
  void PrintProfilerConf() {
    ...
    std::cout << "gpu pc sampling period       : " << samplingPeriod
              << std::endl;
    std::cout << "scratch buffer size          : " << scratchBufSize
              << std::endl;
    std::cout << "hw buffer size               : " << hwBufSize << std::endl;
    std::cout << "configuration buffer size    : " << pcConfigBufRecordCount
              << std::endl;
    std::cout << "circular buffer count        : " << circularbufCount
              << std::endl;
    std::cout << "circular buffer record count : " << circularbufSize
              << std::endl;

    std::cout << "cpu pc sampling period       : " << cpuSamplingPeriod
              << std::endl;
    std::cout << "cpu pc sampling buffer pages : " << cpuSamplingPages
              << std::endl;
    std::cout << "cpu pc sampling timeout      : " << cpuSamplingTimeout
              << std::endl;
    std::cout << "cpu pc sampling max depth    : " << cpuSamplingMaxDepth
              << std::endl;

    std::cout << "fake CCT                     : " << fakeBT << std::endl;
    std::cout << "do CPU call stack unwinding  : " << doCPUCallStackUnwinding
              << std::endl;
    std::cout << "check rsp                    : " << checkRSP << std::endl;
    std::cout << "prune cct                    : " << pruneCCT << std::endl;
    std::cout << "sync before start/stop       : " << syncBeforeStart
              << std::endl;
    std::cout << "backtrace verbose            : " << backTraceVerbose
              << std::endl;
    std::cout << "do py unwinding              : " << doPyUnwinding
              << std::endl;
    std::cout << "no RPC                       : " << noRPC << std::endl;
    std::cout << "no GPU Sampling              : " << noSampling << std::endl;
    std::cout << "enable CPU sampling          : " << enableCPUSampling
              << std::endl;

    std::cout << "dl backend                   : " << backEnd << std::endl;
    std::cout << "python file name             : " << pyFileName << std::endl;
    if (noRPC) {
      std::cout << "dump file name (no)          : " << dumpFileName
                << std::endl;
    }

    std::cout << "main thread tid              : " << mainThreadTid
              << std::endl;
    std::cout << "================================================="
              << std::endl;
    std::cout << std::endl;
